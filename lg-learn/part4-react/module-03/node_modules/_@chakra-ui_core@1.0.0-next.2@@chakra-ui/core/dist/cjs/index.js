...
Object.keys(_focusLock).forEach(function (key) {
  if (key === "default" || key === "__esModule") return;
  exports[key] = _focusLock[key];
});

var _liveRegion = require("@chakra-ui/live-region");
...
Object.keys(_clickable).forEach(function (key) {
  if (key === "default" || key === "__esModule") return;
  exports[key] = _clickable[key];
});
